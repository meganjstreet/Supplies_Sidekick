...
Supply.create(name: "Wood Planks", description: "1000 wooden planks", address: "1 Somerset Road, Green Point, Cape Town", img_url:"https://housing.com/news/wp-content/uploads/2023/04/What-is-timber-wood-and-which-are-the-best-types-f.jpg", price:100, quantity:100, user: User.find_by(first_name: "Luvo"))
...
Supply.create(name: "Nails", description: "Big pot of nails", address: "Cape Town", img_url:"https://housing.com/news/wp-content/uploads/2023/04/What-is-timber-wood-and-which-are-the-best-types-f.jpg", price:888, quantity:4, user: User.find_by(first_name: "Luvo") )
...
Supply.create(name: "Scaffold hoists", description: "Scaffold hoists set in good condition", address: "15 Beach Rd, Strand, Cape Town", img_url: "https://www.hoistandaccess.com/assets/uploads/images/equipment/scaffold-hoist-3.jpg", price:750, quantity:4380, user: User.find_by(first_name: "Luvo") )
