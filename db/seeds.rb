...
Supply.create(name: "Nails", description: "Big pot of nails", address: "40 St Georges Mall, City Centre, Cape Town", img_url:"https://housing.com/news/wp-content/uploads/2023/04/What-is-timber-wood-and-which-are-the-best-types-f.jpg", price:888, quantity:4, user: User.find_by(first_name: "Meg") )
Supply.create(name: "Sand paper", description: "5 sheets of sandpaper", address: "5 Voortrekker Rd, Belmont Park, Kraaifontein, Cape Town", img_url: "https://upload.wikimedia.org/wikipedia/commons/thumb/9/90/Schleifpapier_verschiedene_Sorten.jpg/800px-Schleifpapier_verschiedene_Sorten.jpg", price:230, quantity:5, user: user: User.find_by(first_name: "Nolu") )
